...
mod tests {
    ...
    use crate::sdk::mcu::register::{
        mock_write_reg8, mock_write_reg_system_tick_irq, mock_read_reg_system_tick,
        mock_write_reg_rf_irq_status, mock_write_reg_rf_access_code, mock_write_reg_rf_crc,
        mock_write_reg_rf_channel, mock_write_reg_rf_mode, mock_write_reg_rf_rx_mode,
        mock_write_reg_rf_txrx_state, mock_write_reg_pll_rx_fine_div_tune,
        mock_read_reg_rf_mode, mock_write_reg_rf_sched_tick, mock_write_reg_rf_mode_control,
        mock_write_reg_dma3_addr
    };
    use crate::sdk::mcu::analog::{mock_analog_write, analog_write};
    use crate::sdk::mcu::clock::CLOCK_SYS_CLOCK_1US;
    ...
    fn test_get_ble_advertisement_channel_count() {
        ...
        assert_eq!(count, 3, "Should return 3 for all three advertisement channels");
    }
    ...
    #[mry::lock(write_reg8, rf_stop_trx, 
                write_reg_system_tick_irq, read_reg_system_tick, write_reg_rf_irq_status)]
    fn test_advertisement_completion_with_online_status() {
        ...
        assert_eq!(BLE_PERIPHERAL_LINK_STATE.get(), crate::sdk::light::BlePeripheralLinkState::Advertising,
    ...
    /// - State transitions to Listen mode
    #[test]
    #[mry::lock(write_reg8, rf_stop_trx, write_reg_system_tick_irq, 
                read_reg_system_tick, write_reg_rf_irq_status)]
    ...
    #[test]
    #[mry::lock(write_reg8, rf_stop_trx, write_reg_rf_access_code, write_reg_rf_crc,
                write_reg_rf_channel, write_reg_rf_mode, write_reg_rf_rx_mode,
                write_reg_rf_txrx_state, write_reg_pll_rx_fine_div_tune, analog_write,
                read_reg_rf_mode, write_reg_rf_sched_tick, write_reg_rf_mode_control,
                write_reg_dma3_addr, write_reg_system_tick_irq, read_reg_system_tick, 
    ...
    fn test_advertisement_channel_cycling() {
        ...
        assert_eq!(BLE_ADVERTISING_ENABLED.get(), true,
    ...
    #[test]
    #[mry::lock(write_reg8, rf_stop_trx, write_reg_system_tick_irq, read_reg_system_tick, write_reg_rf_irq_status)]
    ...
    fn test_rapid_advertisement_cycles() {
        ...
        for cycle in 0..3 {
            ...
            assert_eq!(BLE_PERIPHERAL_LINK_STATE.get(), crate::sdk::light::BlePeripheralLinkState::Advertising,
                "Link state should be advertising in cycle {}", cycle);
            ...
            if cycle < 2 {
                assert_eq!(BLE_ADVERTISING_ENABLED.get(), true,
                    "Advertisement should remain enabled during sequence cycle {}", cycle);
            } else {
                assert_eq!(BLE_ADVERTISING_ENABLED.get(), false,
                    "Advertisement should be auto-disabled after complete sequence (cycle {})", cycle);
            }
        }
