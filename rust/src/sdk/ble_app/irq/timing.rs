...
mod tests {
    ...
    use crate::sdk::mcu::clock::{CLOCK_SYS_CLOCK_1US, mock_sleep_us};
    use crate::sdk::ble_app::rf_drv_8266::{
        mock_rf_stop_trx, mock_rf_set_ble_channel, mock_rf_start_brx
    };
    use crate::sdk::ble_app::ble_ll_channel_selection::mock_ble_ll_select_next_data_channel;
    use crate::sdk::ble_app::irq::connection::{mock_handle_ble_connection_parameter_updates, handle_ble_connection_parameter_updates};

    use crate::sdk::mcu::register::{
        mock_write_reg8, mock_write_reg_rf_access_code, mock_write_reg_rf_crc,
        mock_read_reg_system_tick, mock_write_reg_system_tick_irq, mock_read_reg_system_tick_irq
    };
    ...
    fn test_configure_ble_receive_state_basic() {
        ...
        assert_eq!(BLE_PERIPHERAL_LINK_STATE.get(), BlePeripheralLinkState::Receiving,
        ...
        assert_eq!(*CURRENT_RF_STATE.lock(), RfOperationState::Connected,
            "State should transition to bridge mode");
        
        // Verify timing adjustment is enabled
        assert_eq!(BLE_PERIPHERAL_TIMING_ADJUSTMENT_ENABLED.get(), true,
    ...
    fn test_configure_ble_receive_state_normal_timing() {
        ...
        assert_eq!(SLAVE_NEXT_CONNECT_TICK.get(), 200000,
