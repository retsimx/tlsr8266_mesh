...
use crate::sdk::mcu::register::{FLD_DMA, FLD_IRQ, read_reg8, read_reg_dma_chn_en, read_reg_dma_chn_irq_msk, read_reg_dma_rx_rdy0, read_reg_irq_mask, write_reg16, write_reg8, write_reg_dma0_addr, write_reg_dma0_ctrl, write_reg_dma1_addr, write_reg_dma_chn_en, write_reg_dma_chn_irq_msk, write_reg_dma_rx_rdy0, write_reg_dma_tx_rdy0, write_reg_irq_mask};
...
pub struct UartDriver {
    txdata_buf: UartDataT, // not for user
    ...
    */
    ...
    pub fn uart_send(&mut self, msg: &UartDataT) -> bool {
        critical_section::with(|_| {
            // Wait a moment to make sure that any tx is finished
            let t_timeout = clock_time();
